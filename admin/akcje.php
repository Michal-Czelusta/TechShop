...
if (!isset($_SESSION['user_id']) || $_SESSION['rola'] !== 'admin') {
    header('Location: /michal-czelusta/logowanie.php');
    exit;
}
require_once '../includes/db.php';

if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    header('Location: /michal-czelusta/admin/index.php');
    exit;
}
...
if (!empty($bledy)) {
    ...
    $redirect = $akcja === 'edytuj' ? '/michal-czelusta/admin/edytuj.php?id=' . (int)$_POST['id'] : '/michal-czelusta/admin/dodaj.php';
...
if ($akcja === 'dodaj') {
    ...
    header('Location: /michal-czelusta/admin/index.php?komunikat=Produkt+został+dodany&typ=sukces');
    ...
    header('Location: /michal-czelusta/admin/index.php?komunikat=Produkt+został+zaktualizowany&typ=sukces');
}
