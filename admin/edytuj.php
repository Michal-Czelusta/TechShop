...
<div class="container page-admin">
    ...
    <a href="/michal-czelusta/admin/index.php" class="btn btn-secondary" style="margin-bottom:24px">&#8592; Wróć do listy</a>
    ...
    <div class="admin-form">
        ...
        <form action="/michal-czelusta/admin/akcje.php" method="POST" id="formDodaj" novalidate>
...
<script src="/michal-czelusta/assets/js/walidacja-admin.js"></script>