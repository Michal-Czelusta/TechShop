...
<div class="container page-admin">
    ...
    <a href="/michal-czelusta/admin/dodaj.php" class="btn btn-primary">+ Dodaj produkt</a>
    ...
    <table class="admin-tabela">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="akcje">
                    <a href="/michal-czelusta/admin/edytuj.php?id=<?= $p['id'] ?>" class="btn btn-secondary btn-sm">Edytuj</a>
                    <a href="/michal-czelusta/admin/usun.php?id=<?= $p['id'] ?>" class="btn btn-danger btn-sm"
