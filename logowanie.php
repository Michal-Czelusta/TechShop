...
<div class="container page-auth">
    <div class="auth-box">
        ...
        <form action="/michal-czelusta/includes/logowanie_akcja.php" method="POST" id="formLogowanie" novalidate>
        ...
        <p class="auth-link">Nie masz konta? <a href="/michal-czelusta/rejestracja.php">Zarejestruj się</a></p>
    </div>
</div>

<?php require_once 'includes/footer.php'; ?>
<script src="/michal-czelusta/assets/js/walidacja-logowanie.js"></script>