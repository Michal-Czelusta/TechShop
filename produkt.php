...
if (!$produkt) {
    header('Location: /michal-czelusta/produkty.php');
    exit;
}
...
<div class="container page-produkt">
    <nav class="breadcrumb">
        <a href="/michal-czelusta/index.php">Strona główna</a> &rsaquo;
        <a href="/michal-czelusta/produkty.php">Produkty</a> &rsaquo;
        <span><?= htmlspecialchars($produkt['nazwa']) ?></span>
    </nav>

    <div class="produkt-szczegoly">
        <div class="produkt-szczegoly-img">
            <img src="/michal-czelusta/assets/img/<?= htmlspecialchars($produkt['zdjecie']) ?>"
        ...
        <div class="produkt-szczegoly-info">
            ...
            <form action="/michal-czelusta/includes/koszyk_akcja.php" method="POST" style="margin-bottom: 12px;">
                <input type="hidden" name="akcja" value="dodaj">
                <input type="hidden" name="produkt_id" value="<?= $produkt['id'] ?>">
                <button type="submit" class="btn btn-primary">&#128722; Dodaj do koszyka</button>
            </form>
            <a href="/michal-czelusta/produkty.php" class="btn btn-secondary">&#8592; Wróć do listy</a>
        </div>
    </div>
</div>
