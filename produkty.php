    ...
    <div class="produkty-layout">
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-list">
                <li><a href="/michal-czelusta/produkty.php" <?= $kategoria_slug === '' ? 'class="active"' : '' ?>>Wszystkie</a></li>
                <?php foreach ($kategorie as $kat): ?>
                    <li>
                        <a href="/michal-czelusta/produkty.php?kategoria=<?= htmlspecialchars($kat['slug']) ?>"
