...
<div class="container page-auth">
    <div class="auth-box">
        ...
        <form action="/michal-czelusta/includes/rejestracja_akcja.php" method="POST" id="formRejestracja" novalidate>
        ...
        <p class="auth-link">Masz już konto? <a href="/michal-czelusta/logowanie.php">Zaloguj się</a></p>
    </div>
</div>

<?php require_once 'includes/footer.php'; ?>
<script src="/michal-czelusta/assets/js/walidacja-rejestracja.js"></script>